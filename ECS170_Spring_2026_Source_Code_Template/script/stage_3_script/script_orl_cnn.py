...
loader = Dataset_Loader(
    dataset_name='ORL',
    dataset_path='../../data/stage_3_data/ORL'
)
...
with open(os.path.join(result_dir, 'orl_results.txt'), 'w') as f:
    f.write('----- FINAL ORL RESULTS -----\n')
...
axes[0].set_title('ORL Loss Curve')
axes[0].legend()
...
axes[1].set_title('ORL Accuracy Curve')
axes[1].legend()

plt.tight_layout()
plt.savefig(os.path.join(result_dir, 'orl_training_curves.png'))
plt.show()