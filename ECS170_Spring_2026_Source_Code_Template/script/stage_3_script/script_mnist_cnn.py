...
loader = Dataset_Loader(
    dataset_name='MNIST',
    dataset_path='../../data/stage_3_data/MNIST'
)
...
with open(os.path.join(result_dir, 'mnist_results.txt'), 'w') as f:
    f.write('----- FINAL MNIST RESULTS -----\n')
...
axes[0].set_title('MNIST Loss Curve')
axes[0].legend()
...
axes[1].set_title('MNIST Accuracy Curve')
axes[1].legend()

plt.tight_layout()
plt.savefig(os.path.join(result_dir, 'mnist_training_curves.png'))
plt.show()